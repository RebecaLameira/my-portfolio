	...
	return (
		<header className="flex flex-wrap m-2 p-4 items-center justify-around mobile:flex-wrap-reverse">
			<div className="laptop:justify-center mobile:justify-center">
				<h1
					className={`${juliusFont.className} bg-white container w-90 h-30 p-2 font-black text-4xl my-8 rounded-md dark:bg-neutral-900`}
				>
					DESENVOLVEDORA <br />
					FRONT-END
				</h1>
				<p className="bg-white text-base p-2 rounded-md dark:bg-neutral-900">
