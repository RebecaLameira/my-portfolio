...
const Footer = ({ children, className }: FooterProps) => {
	return (
		<footer
			className={`flex w-full py-2 px-14 bg-white box inset-x-0 bottom-0 items-center shadow-inner justify-between mobile:justify-center dark:bg-black dark:border-none mobile:relative dark:shadow-2xl ${className}`}
		>
